    ...
    useEffect(() => {
        if (auth.token) {
            const fetchMember = async () => {
                try {
                    const response = await fetch(`${API_URL}/user/get-by-token`, {
                        method: "GET",
                        headers: {
                ...
                <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                    <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
                        ...
                        <div className="order-3 xl:order-2">
                            <h4 className="uppercase mb-2 text-lg font-semibold text-center text-gray-800 dark:text-white/90 xl:text-left">
                                {tableData?.user_name}
                            </h4>
